...
export const routes: AppRoute[] = [
  ...
  { path: '/admin/profile', label: '后台个人中心', element: <AdminPage /> },
  { path: '/admin/my-articles', label: '后台我的文章', element: <AdminPage /> },
  ...
  { path: '/admin/knowledge', label: '后台知识库管理', element: <AdminPage /> },
